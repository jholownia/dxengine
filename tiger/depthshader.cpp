...
================
*/
bool DepthShader::init( ID3D10Device* device, HWND hwnd)
{
	return initShader(device, hwnd, L"depth.fx");
}
...
================
*/
bool DepthShader::initShader( ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
	HRESULT result;
	...
	technique_ = effect_->GetTechniqueByName("DepthTechnique");
	if(!technique_)
	{
		return false;
	}
...
/*
================
 DepthShader::outputShaderErrorMessage
================
*/
