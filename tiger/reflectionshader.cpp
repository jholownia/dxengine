...
================
*/
bool ReflectionShader::init( ID3D10Device* device, HWND hwnd)
{
	return initShader(device, hwnd, L"reflection.fx");
}
/*
================
...
/*
================
 ReflectionShader::render
================
*/
void ReflectionShader::render( ID3D10Device* device, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D10ShaderResourceView* texture, ID3D10ShaderResourceView* reflectionTexture, D3DXMATRIX reflectionMatrix)
{
...
/*
================
 ReflectionShader::initShader
================
*/
bool ReflectionShader::initShader( ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
	HRESULT result;
	...
	technique_ = effect_->GetTechniqueByName("ReflectionTechnique");
	if(!technique_)
	{
		return false;
	}
	...
	// Get pointers for reflection texture and reflection matrix
...
/*
================
 ReflectionShader::outputShaderErrorMessage
================
*/
...
/*
================
 ReflectionShader::setShaderParameters
================
*/
void ReflectionShader::setShaderParameters( D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D10ShaderResourceView* texture, ID3D10ShaderResourceView* reflectionTexture, D3DXMATRIX reflectionMatrix)
{
...
/*
================
 ReflectionShader::renderShader
================
*/
void ReflectionShader::renderShader( ID3D10Device* device, int indexCount)
{
